...
# Function to convert PDF to text and append to temp.txt
def convert_pdf_to_text(overlap=200):
    ...
    if file_path:
        with open(file_path, 'rb') as pdf_file:
            ...
            print(f"PDF content appended to temp.txt with each chunk on a separate line.")


# Function to upload a text file and append to temp.txt
def upload_txtfile():
    ...
    if file_path:
        with open(file_path, 'r', encoding="utf-8") as txt_file:
            ...
            print(f"Text file content appended to temp.txt with each chunk on a separate line.")


# Function to upload a JSON file and append to temp.txt
def upload_jsonfile():
        ...
        with open(file_path, 'r', encoding="utf-8") as json_file:
            ...
            with open("temp.txt", "a", encoding="utf-8") as temp_file:
                for chunk in chunks:
                    # Write each chunk to its own line
                    temp_file.write(chunk.strip() + "\n")  # Two newlines to separate chunks
            print(f"JSON file content appended to temp.txt with each chunk on a separate line.")
